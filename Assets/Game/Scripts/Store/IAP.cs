...
// one of the existing Survival Shooter scripts.
    ...
    public class IAP : MonoBehaviour, IStoreListener
    {
		...
		public static IAP Instance{
			get{ if (!instance)	instance=FindObjectOfType<IAP>();
				return instance; }
		}
        ...
        public static string PRODUCT_TICKETS_1000 = "tickets1000";
        ...
        public void Buy1000Tickets()
        {
            ...
            BuyProductID(PRODUCT_TICKETS_1000);
        }
        ...
        void BuyProductID(string productId)
        {
            ...
            if (IsInitialized())
            {
			ItavioController.Instance.OpenTransaction((bool success) => {
				// ... look up the Product reference with the general product identifier and the Purchasing 
				// system's products collection.
				Debug.Log("Buy listener");
				if(success){
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_TICKETS_1000, StringComparison.Ordinal))
            {
                Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
                // The consumable item has been successfully purchased, add 100 coins to the player's in-game score.

                ScoreController.Instance.CantTickets += 1000;
			ItavioController.Instance.CloseTranaction (true);
            }
            // Or ... an unknown product has been purchased by this user. Fill in additional products here....
            else
            {
                Debug.Log(string.Format("ProcessPurchase: FAIL. Unrecognized product: '{0}'", args.purchasedProduct.definition.id));
			ItavioController.Instance.CloseTranaction (false);
